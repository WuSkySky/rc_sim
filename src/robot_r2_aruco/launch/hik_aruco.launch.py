"""Launch hik_camera + aruco_detect + debug_saver for HIK camera ArUco testing."""
...
def generate_launch_description():
    ...
    hik_config = os.path.join(
        hik_share, 'config', 'hik_camera.yaml',
    )
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            remappings=[
                ('/r2/hik_camera/image_raw', '/image_raw'),
                ('/r2/hik_camera/image_raw/debug', '/image_raw/debug'),
                ('/r2/hik_camera/camera_info', '/camera_info'),
            ],
        ),
        Node(
