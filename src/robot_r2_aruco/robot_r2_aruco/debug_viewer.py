#!/usr/bin/env python3
"""Real-time tkinter window showing the /r2/aruco/debug image stream."""
...
class DebugViewerNode(Node):
    """Subscribe to /r2/aruco/debug and update a tkinter window."""
    ...
    def __init__(self) -> None:
        ...
        self.get_logger().info(
            "viewer subscribed to /r2/aruco/debug — point the marker "
            "at the camera"
        )
