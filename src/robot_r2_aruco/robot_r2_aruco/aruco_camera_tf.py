...
class ArucoCameraTf(Node):
    ...
    def _on_camera_info(self, message: CameraInfo) -> None:
        ...
        with self._state_lock:
            changed = frame_id != self._camera_frame_id
            if changed:
    ...
    def _on_parameters_changed(self, parameters) -> SetParametersResult:
        ...
        with self._state_lock:
            ...
            has_camera_frame = bool(self._camera_frame_id)
        if has_camera_frame:
            self._broadcast()
    ...
    def _broadcast(self) -> None:
        ...
        transform.transform.translation.x = camera_xyz[0]
        transform.transform.translation.y = camera_xyz[1]
        transform.transform.translation.z = camera_xyz[2]
